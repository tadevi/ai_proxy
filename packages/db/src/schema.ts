...
export const connectionTokens = pgTable(
  'connection_tokens',
  {
    ...
    enabled: boolean('enabled').default(true).notNull(),
    // System-managed credentials are generated by the gateway (currently for CLIProxyAPI).
    // They must not be exposed or mutated through the user-facing token API.
